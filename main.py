...
if __name__ == '__main__':
    with psycopg2.connect(database="netology_clients_db", user="postgres", password="postgres") as conn:
        with conn.cursor() as cur:
            ...
            # add_client(cur, 'Иван', 'Иванов', 'iivanov@gmail.com', '+79818474738')
            # add_client(cur, 'Мария', 'Сазонова', 'saz1212@gmail.com')
            # add_client(cur, 'Кристиан', 'Белозубиков', 'cris666@gmail.com', '+79263452323')
            # add_client(cur, 'Вася', None, None)
            # add_client(cur, 'Нина', 'Креветко', None)
            # add_client(cur, 'Максим', 'Иванов', 'iii@gmail.com')
            #
            # all_clients(cur)
            #
            # print(get_phone(cur, '1', '+79818474738'))
